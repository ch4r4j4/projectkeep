...
const DeleteButton = () => {
  ...
  return (
    <div className="relative">
      ...
      {showMenu && (
        <div className="absolute top-full mt-2 left-0 bg-white border rounded shadow-lg p-4 z-10">
...
///otra vez un simple commit para rellenar nuestro path en el github
